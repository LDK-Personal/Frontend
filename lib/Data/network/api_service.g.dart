...
class _ApiService implements ApiService {
  ...
  Future<List<BoardResponse>> getBoardItems() async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<BoardResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<bool> saveBoardItem(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<PredictResponse> uploadFile(
    File file, {
